	...
	return (
		<>
			<Flex direction={"column"} width={"100%"} align="center">
				...
				<Flex alignItems={"center"} height={"100%"}>
					<Flex align="center" justify="center" paddingLeft="15%" width={"70%"} marginTop={"2.5rem"}> 
						<ChessIcon width="25%" height="auto" />
						<Heading width="5%" color="primary" fontSize="3xl">
						</Heading>
						<Heading textAlign="center" width="70%" color="primary" fontSize="3xl">
							Chess Tournament
						</Heading>
					</Flex>
				</Flex>
				<Flex alignItems={"center"} height={"100%"}> 
					<Flex align="center" justify="center" paddingLeft="5%" width={"90%"} marginTop={"2.5rem"}> 
				...
				<Flex alignItems={"center"} height={"100%"} marginBottom={"7.5rem"}>
					<Flex align="center" justify="center" paddingLeft="5%" width={"70%"} marginTop={"2.5rem"}> 
						<WorkshopsIcon width="27.5%" height="auto" />
						<Heading width="17.5%" color="primary" fontSize="3xl">
						</Heading>

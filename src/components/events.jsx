...
export default function Events() {
  ...
  return (
    <Flex marginLeft={"7rem"} marginTop={"10rem"} direction={"column"}>
      ...
      <Heading color="primary" fontSize="5xl" data-aos="fade-left" data-aos-duration="1000">
        Events
      </Heading>
      ...
      <Text color="primary" fontSize="xl" marginTop={"2.5rem"} width={"70%"} data-aos="fade-left" data-aos-duration="1000">
